...
Нет, не вижу, т.к. все запросы во втором окне в рамках начатой транзакции на уровне repeatable read не будут видеть изменения сделанные в других транзакциях.
